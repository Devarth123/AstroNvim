...
_G.packer_plugins = {
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/devarth/.local/share/nvim/site/pack/packer/start/presence.nvim",
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'cinnamon.nvim', 'null-ls.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'FixCursorHold.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'cinnamon.nvim', 'null-ls.nvim', 'nvim-treesitter', 'lsp_signature.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'FixCursorHold.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
